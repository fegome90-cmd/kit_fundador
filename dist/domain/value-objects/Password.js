...
export class Password {
     ...
     * @private
     */
    static validateSaltRoundsFormat(envValue) {
     ...
     * @private
     */
    static validateSaltRoundsRange(saltRounds) {
        if (saltRounds < MIN_SALT_ROUNDS || saltRounds > MAX_SALT_ROUNDS) {
            throw new Error(`Invalid PASSWORD_SALT_ROUNDS: ${saltRounds} must be between ${MIN_SALT_ROUNDS} and ${MAX_SALT_ROUNDS}`);
        }
    }
    /**
