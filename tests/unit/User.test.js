...
describe('User Entity', () => {
    describe('create', () => {
        it('should create a valid user', () => {
            ...
            const password = Password_1.Password.create(STRONG_PASSWORD);
            // Act
    ...
    describe('verifyEmail', () => {
        it('should verify email successfully', () => {
            // Arrange
            const user = User_1.User.create({
                email: Email_1.Email.create('test@example.com'),
                name: 'Test User',
                password: Password_1.Password.create(STRONG_PASSWORD),
            });
            // Act
            user.verifyEmail();
            // Assert
    ...
    describe('isAdmin', () => {
        it('should return true for admin users', () => {
            const user = User_1.User.create({
                email: Email_1.Email.create('admin@example.com'),
                name: 'Admin User',
                password: Password_1.Password.create('SecurePass123!'),
                role: 'admin',
            });
    ...
    describe('changePassword', () => {
        it('should change password successfully', () => {
            const user = User_1.User.create({
                email: Email_1.Email.create('test@example.com'),
                name: 'Test User',
                password: Password_1.Password.create('OldPass1234!'),
            });
            const newPassword = Password_1.Password.create('NewPass4567!');
        ...
        it('should update updatedAt timestamp', () => {
            ...
            user.changePassword(Password_1.Password.create('NewSecurePass123!'));
    ...
    describe('fromPersistence', () => {
        it('should reconstitute user from persistence', () => {
            const email = Email_1.Email.create('persisted@example.com');
            const password = Password_1.Password.create(STRONG_PASSWORD);
            const now = new Date();
            const user = User_1.User.fromPersistence({
                id: 'test-id-123',
                email,
                name: 'Persisted User',
                password,
    ...
    describe('toJSON', () => {
        it('should serialize to JSON without password', () => {
            const user = User_1.User.create({
                email: Email_1.Email.create('json@example.com'),
                name: 'JSON User',
                password: Password_1.Password.create(STRONG_PASSWORD),
                role: 'user',
            });
